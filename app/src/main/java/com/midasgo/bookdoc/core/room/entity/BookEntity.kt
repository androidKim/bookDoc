package com.midasgo.bookdoc.core.room.entity
...
data class BookEntity (@PrimaryKey(autoGenerate = true) var seq:Long,
                       ...
                       @ColumnInfo(name = "img_url") var img_url: String)
{
    constructor():this(0,"","","","","","")
    companion object{
        fun getEntity(pInfo:book):BookEntity
        {
            val bookEntity:BookEntity = BookEntity()
            bookEntity.seq = pInfo.seq
